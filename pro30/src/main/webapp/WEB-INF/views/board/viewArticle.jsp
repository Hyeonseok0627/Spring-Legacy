...
<head>
   ...
   /* 해당 아이디의 속성을 한번에 변경하는 함수 */
	...
	/* 삭제 시 사용할 함수 */
	/* 삭제 시, 1)삭제할 게시글 번호와 2)삭제를 처리하는 서버의 맵핑 주소 전달 */
/* 	기존에는 html 폼에 작성이 다된 상태로 작업을 했다면,
	지금은 inner HTML이라고 해서, 동적으로 개발작품, 폼 요소, 속성, 임의로 만들어서
	html 문서에 주입을 하는 형식. */
	 function fn_remove_article(url,articleNO){
		/* 동적으로 form 태그를 만들기(createElement 함수 사용) */
		 var form = document.createElement("form");
		/* form 요소에, 속성으로, 전달 방식 post, action : 전송 폼에서 submit 클릭 시,
		서버로 데이터를 전부 다 전달 위치 */
...
/* 	 답장을 하는 폼도, 동적으로 폼을 구성, 하위에 입력 태그라든지, 요소를 추가해서
	 body라는 태그에 붙이는 작업 */
	 ...
	 function readURL(input) {
	     if (input.files && input.files[0]) {
	         ...
	         /* #preview div 태그 아이디로 사용하게 되는 태그 */
...
<body>
  ...
  <tr>
   ...
   <td >
   <!-- disabled로 속성 설정한 것은, 서버에 데이터를 전달 못하게 됨 -->
